...
const RightSideBar = () => {
  ...
  //get all images and set them to state i.e get images from chat and add to array
      ...
      <div className="px-5 text-xs">
        ...
        <div className="mt-2 max-h-[200px] overflow-y-scroll grid grid-cols-2 gap-4 opacity-80">
          {msgImages.map((url, index) => (
            <div key={index} onClick={() => window.open(url)} className="cursor-pointer rounded w-full aspect-square">
