...
const ProfilePage = () => {
  ...
  const handleSubmit = async(e)=>{
    ...
    const reader = new FileReader()  //to send image we have convert it itno base-64 image
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
        <div className='w-5/6 max-w-2-xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'> 
          ...
          className='flex flex-col gap-5 p-10 flex-1'>
            ...
            <input onChange={(e)=>setName(e.target.value)} value={name}
             ...
             placeholder='Write something about you.' required className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500' rows={4}></textarea>
